    ...
    try {
        ...
        if (cleanedResponse.length > 0 || imageMatches.length > 0) {
            ...
            if (isTtsEnabled && cleanedResponse) {
                // Use Voice ID if available, fallback to old voiceURI, default to Puck
        ...
        <div className="flex items-center bg-background-secondary rounded-lg p-2">
          ...
          <button 
            ...
            <button 
                ...
                title={isTtsEnabled ? "Disable Auto-TTS (GenAI)" : "Enable Auto-TTS (GenAI)"} 
          ...
          <button onClick={handleNarratorButtonClick} title="Narrate" className="p-2 text-text-secondary hover:text-primary-500 disabled:opacity-50" disabled={isInputDisabled}>
            <BookIcon className="w-6 h-6" />
          </button>
          <button onClick={handleImageButtonClick} title="Generate Image" className="p-2 text-text-secondary hover:text-primary-500 disabled:opacity-50" disabled={isInputDisabled}>
